...
@section('content')
        ...
        <div class="hero-slider owl-carousel">
            <div class="hero-item set-bg d-flex align-items-center justify-content-center text-center" data-setbg="/images/slider-bg-1.jpg">
                <div class="container">
                    ...
                    <a href="#" class="site-btn">Read More  <img src="{{ url('/images/icons/double-arrow.png') }}" alt="#"/></a>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="intro-text-box text-box text-white">
                        ...
                        <a href="#" class="read-more">Read More  <img src="{{ url('/images/icons/double-arrow.png') }}" alt="#"/></a>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="intro-text-box text-box text-white">
                    ...
                    <div id="stickySidebar">
                        <div class="widget-item">
                            ...
                            <div class="trending-widget">
                                <div class="tw-item">
                                    <div class="tw-thumb">
                                        <img src="{{ url('/images/blog-widget/1.jpg') }}" alt="#">
                                    </div>
                                    <div class="tw-text">
                                ...
                                <div class="tw-item">
                                    <div class="tw-thumb">
                                        <img src="{{ url('/images/blog-widget/2.jpg') }}" alt="#">
                                    </div>
                                    <div class="tw-text">
                                        <div class="tw-meta">11.11.18  /  in <a href="">Games</a></div>
                                        <h5>The best online game is out now!</h5>
                                ...
                                <div class="tw-item">
                                    <div class="tw-thumb">
                                        <img src="{{ url('/images/blog-widget/3.jpg') }}" alt="#">
                                    </div>
                                    <div class="tw-text">
                                        <div class="tw-meta">11.11.18  /  in <a href="">Games</a></div>
                                        <h5>The best online game is out now!</h5>
                                ...
                                <div class="tw-item">
                                    <div class="tw-thumb">
                                        <img src="{{ url('/images/blog-widget/4.jpg') }}" alt="#">
                                    </div>
                                    <div class="tw-text">
                                        <div class="tw-meta">11.11.18  /  in <a href="">Games</a></div>
                                        <h5>The best online game is out now!</h5>
                        ...
                        <div class="widget-item">
                            <a href="#" class="add">
                                <img src="{{ url('/images/add.jpg') }}" alt="">
                            </a>
                        </div>
                    </div>
                </div>
    ...
    <!-- Intro section -->
    <section class="intro-video-section set-bg d-flex align-items-end " data-setbg="/images/promo-bg.jpg">
        <a href="https://www.youtube.com/watch?v=uFsGy5x_fyQ" class="video-play-btn video-popup"><img src="{{ url('/images/icons/solid-right-arrow.png') }}" alt="#"></a>
        <div class="container">
    ...
    <section class="featured-section">
        <div class="featured-bg set-bg" data-setbg="/images/featured-bg.jpg"></div>
